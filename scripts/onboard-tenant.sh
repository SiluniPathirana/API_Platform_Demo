...
# server-to-server), not by this script or a browser, so it needs the
# container-reachable hostname (host.docker.internal), the same reasoning
# as config.toml's auth.idp.token_url — see
